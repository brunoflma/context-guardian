...
**🛡️ SEGURANÇA (Path Traversal Prevention):**
O valor `[slug]` DEVE ser sanitizado antes de gerar o arquivo.

- Remova todas as barras (`/`, `\`) e pontos (`.`).
- Mantenha apenas caracteres alfanuméricos e hífens (`a-z`, `0-9`, `-`).
- NUNCA permita que o nome do projeto ou usuário force a saída do arquivo para fora do diretório `/mnt/user-data/outputs/`.
