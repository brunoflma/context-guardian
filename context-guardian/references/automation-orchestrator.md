...
def extract_handoff_prompt(report: str) -> str:
    ...
    # Otimização de performance: usa find com string slicing em vez de partition
    # para evitar a alocação de memória para um prefixo massivo e inútil em relatórios grandes (200k+ tokens)
