...
def extract_handoff_prompt(report: str) -> str:
    ...
    # Otimização de performance: usa find + slicing em vez de partition
    # para evitar a alocação de memória de um prefixo gigante e não utilizado
    # em relatórios grandes (200k+ tokens).
