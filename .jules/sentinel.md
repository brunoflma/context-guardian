...
## 2024-05-24 - Unhandled API Exceptions Leak Stack Traces
**Vulnerability:** External API calls to Anthropic SDK were not wrapped in try-catch blocks.
**Learning:** Unhandled exceptions can leak internal execution paths, environment information, and sensitive stack traces to users.
**Prevention:** Always wrap external API interactions in try...except or try...catch blocks with generic error logging to fail securely.
